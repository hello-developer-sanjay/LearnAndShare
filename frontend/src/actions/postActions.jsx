...
export const fetchPostBySlug = (slug) => async dispatch => {
    try {
        const res = await axios.get(`https://learnandshare-api-27dec.onrender.com/api/posts/post/${slug}`);
...
export const searchPosts = (keyword) => async (dispatch) => {
    try {
        const res = await axios.get(`https://learnandshare-api-27dec.onrender.com/api/posts/search?keyword=${keyword}`);
...
export const fetchPosts = () => async dispatch => {
    ...
    try {
        const res = await axios.get('https://learnandshare-api-27dec.onrender.com/api/posts');
...
export const fetchUserPosts = () => async dispatch => {
    ...
    try {
        const res = await axios.get('https://learnandshare-api-27dec.onrender.com/api/posts/user', {
            headers: {
                'x-auth-token': token
            }
        });
...
export const addPost = (title, content, category, subtitles, summary, titleImage, superTitles, titleVideo) => async (
    ...
    try {
        const res = await axios.post('https://learnandshare-api-27dec.onrender.com/api/posts', {
            title,
            content,
            category,
            subtitles,
...
export const updatePost = (postId, title, content) => async (dispatch, getState) => {
    ...
    try {
        const res = await axios.put(`https://learnandshare-api-27dec.onrender.com/api/posts/${postId}`, { title, content }, {
            headers: {
                'x-auth-token': token
            }
        });
...
export const deletePost = (postId) => async dispatch => {
    ...
    try {
        await axios.delete(`https://learnandshare-api-27dec.onrender.com/api/posts/${postId}`, {
            headers: {
                'x-auth-token': token
            }
        });
...
export const markPostAsCompleted = (postId) => async (dispatch, getState) => {
    ...
    try {
        const res = await axios.put(`https://learnandshare-api-27dec.onrender.com/api/posts/complete/${postId}`, null, {
            headers: {
                'x-auth-token': token
            }
        });
...
export const fetchCompletedPosts = () => async (dispatch, getState) => {
    ...
    try {
        const res = await axios.get('https://learnandshare-api-27dec.onrender.com/api/posts/completed', {
            headers: {
                'x-auth-token': token
            }
        });
